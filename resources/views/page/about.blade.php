...
<div class="inner-header">
	...
	<div class="container">
		<div id="content">
			<div class="our-1">
				<h2 class="text-center wow fadeInDown">Our 1</h2>
				<div class="space35">&nbsp;</div>

				<div class="1-slider">
					<div class="1-navigation">
					...
					<div class="1-slides">
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="source/image/product/avt.jpg" alt="">
							</div>
							<div class="col-sm-7">
						...
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="source/image/product/1.jpg" alt="">
							</div>
							<div class="col-sm-7">
						...
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="source/image/product/2.jpg" alt="">
							</div>
							<div class="col-sm-7">
						...
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="source/image/product/3.jpg" alt="">
							</div>
							<div class="col-sm-7">
						...
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="source/image/product/4.jpg" alt="">
							</div>
							<div class="col-sm-7">
						...
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="source/image/product/5.jpg" alt="">
							</div>
							<div class="col-sm-7">
						...
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="source/image/product/6.jpg" alt="">
							</div>
							<div class="col-sm-7">
			...
			<div class="row">
				<div class="col-sm-6 wow fadeInLeft">
					<div class="beta-person media">
						...
						<img class="pull-left" src="source/image/product/6.jpg" alt="">
				...
				<div class="col-sm-6 wow fadeInRight">
					<div class="beta-person media ">
						...
						<img class="pull-left" src="source/image/product/7.jpg" alt="">
			...
			<div class="row">
				...
				<div class="bets-img-hover">
						<img src="source/image/product/8.jpg" alt="">
				</div>
				...
				<div class="col-sm-3">
					<div class="beta-person beta-person-full">
					<div class="bets-img-hover">
						<img src="source/image/product/9.jpg" alt="">
					</div>
						<div class="beta-person-body">
							<h5>Bob Robertson</h5>
							<p class="font-large">Web developer</p>
				...
				<div class="col-sm-3">
					<div class="beta-person beta-person-full">
					<div class="bets-img-hover">
						<img src="source/image/product/10.jpg" alt="">
					</div>
						<div class="beta-person-body">
							<h5>Mike Greenwood</h5>
							<p class="font-large">Web developer</p>
				...
				<div class="col-sm-3">
					<div class="beta-person beta-person-full">
					<div class="bets-img-hover">	
						<img src="source/image/product/11.jpg" alt="">
					</div>
						<div class="beta-person-body">
							<h5>David Black</h5>
							<p class="font-large">Web developer</p>
